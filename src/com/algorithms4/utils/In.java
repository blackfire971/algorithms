...
public final class In {
    ...
    public char readChar() {
        ...
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'char' value from input stream, but there are no " +
    ...
    public String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String' value from input stream, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public int readInt() {
        try {
            ...
            throw new InputMismatchException("attempts to read an 'int' value from input stream, but the next token " +
                    "is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read an 'int' value from input stream, but there are no more" +
                    " tokens available");
        }
    }
    ...
    public double readDouble() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'double' value from input stream, but the next token" +
                    " is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'double' value from input stream, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public float readFloat() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'float' value from input stream, but the next token " +
                    "is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'float' value from input stream, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'long' value from input stream, but the next token " +
                    "is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'long' value from input stream, but there are no more" +
                    " tokens available");
        }
    }
    ...
    public short readShort() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'short' value from input stream, but the next token " +
                    "is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'short' value from input stream, but there are no " +
                    "more tokens available");
        }
    }
    ...
    public byte readByte() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'byte' value from input stream, but the next token " +
                    "is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'byte' value from input stream, but there are no more" +
                    " tokens available");
        }
    }
    ...
    public boolean readBoolean() {
        try {
            ...
            throw new InputMismatchException("attempts to read a 'boolean' value from input stream, but the next " +
                    "token is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'boolean' value from input stream, but there are no " +
                    "more tokens available");
        }
    }
